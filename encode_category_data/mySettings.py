...
def get_category_data_encoder_setting_dict():
    ...
    category_data_encoder_setting_dict["encode_category_data_TCGA-gene"]={
        "original_data_excel": base_dataPath+"/gene_label/TCGA_subtypes.xlsx",
        "save_encoded_data_excel_path":base_dataPath+"/gene_label/TCGA_subtypes_encoded.xlsx",
        "category_column_list": ["Gender", "Study", "IDH.status",  "X1p.19q.codeletion", "MGMT.promoter.status"],
        "drop_nan_column_list": ["Gender", "Study", "IDH.status",  "X1p.19q.codeletion", "MGMT.promoter.status"],
