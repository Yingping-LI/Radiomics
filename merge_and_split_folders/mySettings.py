...
def get_split_folder_setting_dict():
    # base path
    base_dataPath="G://PhDProjects/RadiogenomicsProjects/GliomasSubtypes/originalData/TCGA/TCIA_Segmentation"     
    ...
    split_folder_setting_dict["TCGA_train"]={
        ...
        "total_number_of_modalities":5,
        "used_to_find_basename": "flair",
        "split_criterion": {"Images":["t1", "t1Gd", "t2", "flair"],
                           "segmentation":["GlistrBoost_ManuallyCorrected", "GlistrBoost"]},
    }
