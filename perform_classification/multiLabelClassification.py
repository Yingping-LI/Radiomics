...
def predict(trained_model_path, test_data, feature_columns, keep_feature_columns, label_column, save_results_path, data_description, threshold_type="threshold_by_f1"):
    ...
    if test_Y is not None:
        ...
        plot_all_ROC_curves_for_multilabel(test_Y, predicted_prob, label_column, save_results_path)
...
"""
def perform_multilabel_classification(task_name, task_settings, basic_settings, a_random_seed):
